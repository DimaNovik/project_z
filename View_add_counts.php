    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <form id="add_count" action="#" method="post">
              ...
              $jsonString = file_get_contents("json/$file.json");
              $decod = iconv("WINDOWS-1251", "UTF-8", $jsonString);
              $data_json = json_decode($decod, true);
              ...
              foreach ($data_json as $key_dig => $entry_dig) {
                ...
                if($zones == 1) {
                  ...
                  <input type='number' name='count_zone_1' id='count_zone_1' max=$digits  placeholder='Максимальна кількість символів: $digitsAll '>
                  </p>";
                }

                if($zones == 2) {
                  echo "<p><label for='count_zone_1' id='label_zone_1'>Шкала 1:</label></br>
                  <input type='number' name='count_zone_1' id='count_zone_1' max=$digits  placeholder='Максимальна кількість символів: $digitsAll '></p>
                  <p><label for='count_zone_2' id='label_zone_2'>Шкала 2:</label></br>
                  <input type='number' name='count_zone_2' id='count_zone_2' max=$digits  placeholder='Максимальна кількість символів: $digitsAll '></p>";
                }
                ...
                if($zones == 3) {
                  ...
                  <p><label for='count_zone_2' id='label_zone_2'>Шкала 2:</label></br>
                  <input type='number' name='count_zone_2' id='count_zone_2' max=$digits  placeholder='Максимальна кількість символів: $digitsAll '></p>
                  <p><label for='count_zone_3' id='label_zone_3'>Шкала 3:</label></br>
                  <input type='number' name='count_zone_3' id='count_zone_3' max=$digits  placeholder='Максимальна кількість символів: $digitsAll '></p>";
                }
              ?>
          ...
          <?
            ...
            file_put_contents("json/$file.json", $newJsonString);
            //перенаправляем страницу назад к списку
            echo "<script> location.replace('View_abonents_tasks.php?name_tasks=$file&clerkid=$clerkid'); </script>";
